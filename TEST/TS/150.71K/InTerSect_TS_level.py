...
filefolder_Calcite_I_SG_167 = '../../Files_Outputs/Calcite_I/TS_vs_V'

filefolder_Calcite_II_SG_14 = '../../Files_Outputs/Calcite_II/TS_vs_V'

filefolder_energetics = 'TS_vs_V_150.71K'

# Calcite I (Red triangles): 
V_C_I, E_C_I = np.loadtxt(os.path.join(filefolder_Calcite_I_SG_167, filefolder_energetics, 'TS_vs_V_150.71K.dat'), skiprows = 1).T

# 14 (Empty grey triangles):
V_14, E_14 = np.loadtxt(os.path.join(filefolder_Calcite_II_SG_14, filefolder_energetics, 'TS_vs_V_150.71K.dat'), skiprows = 1).T
...
plt.ylabel(r'TS / F.U. (a.u.)', fontsize=20)
