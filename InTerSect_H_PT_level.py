...
V_C_I, ET_C_I = np.loadtxt(os.path.join(filefolder_Calcite_I_SG_167_ET, 'ET_vs_V', 'ET_vs_V_a', 'ET_vs_V_a.dat'), skiprows = 1).T
...
V_14, ET_14 = np.loadtxt(os.path.join(filefolder_Calcite_II_SG_14_ET, 'ET_vs_V', 'ET_vs_V_a', 'ET_vs_V_a.dat'), skiprows = 1).T
